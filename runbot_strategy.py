...
from my_strategy_bot import MyStrategyBot, MyStrategyConfig
...
async def main():
    ...
    config = MyStrategyConfig(
        ...
        stop_loss_immediate=args.stop_loss_immediate,
...
if __name__ == "__main__":
    ...
    #     # 捕获外部的 Ctrl+C 信号，让程序安静地退出，而不打印冗长的 Traceback
    #     pass
